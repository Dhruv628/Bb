  ...
  return (
    <div>
        ...
        <div className="navbar-menu relative z-50 hidden overflow-y-hidden">
          ...
          <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
            <div className="flex items-center mb-8">
              ...
              <p className="text-xl font-bold text-black font-sans mt-10 mb-5">Abhay Studio</p>
              <hr></hr>
              ...
              <button className="navbar-close" onClick={toggleMobileClose}>
                <svg
              ...
              <div className="pt-6">
                {isLoggedIn ? (
                  ...
                  <div className="flex flex-col ">
                    <Link
                      className="block px-4 py-3 mb-2 font-sans leading-loose text-xs text-center text-white font-semibold bg-blue-500 hover:bg-blue-400  rounded-xl"
...

      {
        ...
        <p className="text-2xl font-bold text-black font-sans">Abhay Studio</p>
        ...
        <div className="lg:hidden">
          <button
            ...
            className="navbar-burger flex items-center text-blue-600 p-3 sm:ml-96"
          >
            <svg
        ...
        <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
          <li>
            <Link
              className={`text-sm font-bold ${
                activeOption === "home" ? "text-blue-600" : "text-gray-400"
              } hover:text-gray-500`}
              href="/"
          ...
          <li>
            <Link
              className={`text-sm font-bold ${
                activeOption === "About" ? "text-blue-600" : "text-gray-400"
              } hover:text-gray-500`}
              href="/components/About"
          ...
          <li>
            <Link
              className={`text-sm font-bold ${
                activeOption === "Contact" ? "text-blue-600" : "text-gray-400"
              } hover:text-gray-500`}
              href="/components/Contact"
        ...
        {isLoggedIn ? (
          ...
          <div className="flex gap-10">
            <Link
              className="hidden cursor-pointer lg:inline-block py-3 px-8 bg-blue-500 hover:bg-blue-600 text-sm text-white font-bold rounded-xl transition duration-200"
              href="/components/SignUp"
            >
              Sign up
            </Link>
            ...
            <Link
              className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-3 px-8 bg-gray-200 hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-xl transition duration-200"
              href="/components/Login"
            >
              Login In
            </Link>
